                ...
                $("#form2").submit(function (event) {
                    ...
                    formData.append('Submit', "Submit");
                        ...
                        $.ajax({
                            ...
                            processData: false,
                            success: function (response) {
                                window.location.replace("add2.php");
                            },
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                alert("Status: " + textStatus);
                                alert("خظأ: " + errorThrown);
                ...
                $("#form3").submit(function (event) {
                    ...
                    formData.append('dynamicChange3', dynamicChange3);
                        ...
                        $.ajax({
                            ...
                            processData: false,
                            success: function (response) {
                                window.location.replace("add3.php");
                            },
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                alert("Status: " + textStatus);
                                alert("خظأ: " + errorThrown);
            ...
            $(document).ready(function () {
                ...
                $("#form4").submit(function (event) {
                        ...
                        $.ajax({
                            ...
                            processData: false,
                            success: function (response) {
                                window.location.replace("add4.php");
                            },
                            error: function (XMLHttpRequest, textStatus, errorThrown) {
                                alert("Status: " + textStatus);
                                alert("خظأ: " + errorThrown);
...
<script>
    Iso_Code:{                  // Currency ISO Code e.g. "USD"
        uSingle :"",                // Unit Singluar Arabic Name e.g. "دولار"
            uDouble
    :
        "",                 // Unit Double Arbic Name e.g. "دولاران"
            uPlural
    :
        "",                 // Unit Plural Arbic Name e.g. "دولارات"
            uGender
    :
        "male"
        or
        "female", // Unit Gender e.g. "male"
            sSingle
    :
        "",                // Sub-Unit Singluar Arabic Name e.g. "سنت"
            sDouble
    :
        "",                 // Sub-Unit Double Arbic Name e.g. "سنتان"
            sPlural
    :
        "",                 // Sub- Unit Plural Arbic Name e.g. "سنتات"
            sGender
    :
        "male"
        or
        "female", // Sub-Unit Gender e.g. "male"
            fraction
    :
        number            // The fraction of the Sub-Unit normally 2 or 3
    }
    ,
    **********************************************************************/
